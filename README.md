...
shim-unsigned-x64-15.8-1.0.4.el9.src.rpm
shim-unsigned-aarch64-15.8-1.0.3.el9.src.rpm
...
vendor_db on aarch64 has signing certificate for kernel different from x86_64 distribution.
vendor_db and vendor_db_aarch64 ESL files as well as X509 certificates provided in the review branch/tag
...
*******************************************************************************
```
7314644c8c5e109f2d2de990474000aedc1370433b7eb05f837cfd237150ee57  shimaa64.efi
463357d34774ae52f3bf94c01464afe9282b727d8f9145982cdfbcee01a7be38  shimx64.efi
```
...
grub.rh,2,Red Hat,grub2,2.06-93.0.1.el9_5,mailto:secalert@redhat.com
grub.ol9,3,Oracle Linux,grub2,2.06,mail:secalert_us@oracle.com
```
...
fwupd-efi.ol,1,Oracle Linux,fwupd,1.9.13,mail:secalert_us@oracle.com
```
...
*******************************************************************************
GRUB2 2.06-93.0.1.el9_5 based on latest available in public RHEL GRUB2 + Oracle customization patches on top
...
- 6.12.0 based kernel with lockdown patches
