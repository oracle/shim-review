...
*******************************************************************************
Dockerfile files to reproduce build is included. Oracle Linux images are available on docker hub and container-registry.orac
le.com.
...
*******************************************************************************
GRUB2 2.02-0.87.0.25.el7.9 based on latest available in public RHEL GRUB2 + Oracle customization patches on top
